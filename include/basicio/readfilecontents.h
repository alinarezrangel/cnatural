...
#if !defined(H_CNATURAL_MODULE_BAICIO_READFILECONTENTS_H_)
#define H_CNATURAL_MODULE_BAICIO_READFILECONTENTS_H_ 1

/**
* @file readfilecontents.h
* BasicIO ReadFileContents function.
*/
...
#endif /* ~H_CNATURAL_MODULE_BAICIO_READFILECONTENTS_H_ */
