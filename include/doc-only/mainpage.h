...
/*
FIXME: Note that this file should be `docs/c/home.md`, but Doxygen not uses
correctly that file. I (Alejandro Linarez Rangel) tried with doxywizard
and others but Doxygen not reads the `docs/c/home.md` as the mainpage. So,
for now this file is a doxygen-adapted version of the `docs/c/home.md`.
*/

/**
* \mainpage CNatural Server C API
*
...
*
* \section sec2 Using the APIs **inside** an API
*
* See the header and source files to get an idea about the import
* order.
*
* \section sec3 Viewing this documentation
*
